...
const Slider = () => {
  ...
  return (
    // ← Mobile: 320px, Laptop: 480px
    <div className="relative w-full overflow-hidden h-[320px] md:h-[480px]">
